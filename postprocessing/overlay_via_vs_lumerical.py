"""Overlay `via_array.py`'s R/T output against a Lumerical RCWA
`grating_power` export (`OUTPUT_RCWA/Via/export_via_grating_power.lsf`).
...
Run with:  python postprocessing/overlay_via_vs_lumerical.py
"""
...
# use. "Rs"/"Ts" (s/TE) matches via_array.py's S_AMPLITUDE=1.0/
# P_AMPLITUDE=0.0 -- switch to "Rp"/"Tp" if the Lumerical excitation was
# actually p/TM.
# ============================================================================
SOLVER_CSV = (
    r"C:\Users\sougata.bhunia\Desktop\Solver_own\sougata_solver\outputs\2026_08_20"
    r"\13_46_03_via_array\output_via_RT.csv"
)
LUMERICAL_TXT = (
    r"C:\Users\sougata.bhunia\Desktop\Solver_own\sougata_solver\OUTPUT_RCWA\Via"
    r"\via_lumerical_RCWA.txt"
)
...
PLOT_FILENAME = "via_vs_lumerical.png"
